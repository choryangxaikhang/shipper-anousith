...
import { QUERY_DEDUCTION } from "../../home/apollo";
export default function DetailDeduct({ _id, onHide }) {
  const [show, setShow] = useState(false);
  const [fetchData, { data: dataBonus, loading }] = useLazyQuery(QUERY_DEDUCTION, {
    ...
    <>
      ...
      >
        ...
        <Modal.Body className="p-2  mr-4">
          ...
          {dataBonus?.deductionPayroll?.data?.map((data, index) => (
            <>
