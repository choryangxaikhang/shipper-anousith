...
export default function DividendReportdd() {
  ...
  }, [numberRows, searchValue, numberPage, newLoadData, getRoomValue, houseID]);
    ...
    <>
      <div className="content__header content__boxed overlapping">
        <div className="content__wrap">
          <h3 className="page-title mb-2 text-white">ລາຍງານຍອດປັນຜົນ</h3>
        </div>
      </div>
                    ...
                    <table className="table table-striped table-sm">
                      <thead>
                        <tr>
                          ...
                          <th className="text-nowrap text-center">ຍອດປັນຜົນ</th>
                              ...
                              <>
                                <tr key={index}>
                                  ...
                                  <td className="text-nowrap text-end">
                                    {item?.fee ? currency(item?.fee) : "0"} ກີບ
                                  </td>
