...
import { CREATE_TYPE, QUERY_TYPE_ROOM } from "./apollo";
    ...
    <>
      <div className="card text-red">
        <div className="card-header text-center">
          <b className="fs-4 text-center">ຟອມບັນທຶກປະເພດຫ້ອງ</b>
        </div>
        <div className="card-body">
          <div className="form-row">
            <div>
              <label className="text-black">
                ຊື່ປະເພດຫ້ອງ (ພາສາລາວ) {valiDate()}
              </label>
          ...
          <div className="form-row mt-3">
            <div>
              <label className="text-black">ຊື່ປະເພດຫ້ອງ (ພາສາອັງກິດ)</label>
              <div className="col-md-12">
                <input
                  name="title_eng"
                  className="form-control form-control-lg"
